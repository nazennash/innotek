  ...
  return (
    <>
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-gray-600">
              Transform your online presence with modern design, optimized performance, and seamless user experience that captivate visitors and drive conversions.
            </p>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Our Website Development Services?</h2>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Our website development services are designed to meet the unique needs of modern businesses, ensuring stunning design, optimized performance, and seamless user experience.
            </p>
          </div>
          <div className="flex flex-wrap -m-4">
            ...
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full transform hover:scale-105 transition-transform duration-300">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <h2 className="text-lg font-medium title-font mb-2">Modern Design</h2>
                <p className="leading-relaxed text-base">
                  Create visually stunning websites with modern design principles that captivate visitors.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full transform hover:scale-105 transition-transform duration-300">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <h2 className="text-lg font-medium title-font mb-2">Optimized Performance</h2>
                <p className="leading-relaxed text-base">
                  Ensure fast loading times and smooth performance with optimized code and best practices.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 md:w-1/3 sm:w-1/2 w-full transform hover:scale-105 transition-transform duration-300">
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <h2 className="text-lg font-medium title-font mb-2">Seamless User Experience</h2>
                <p className="leading-relaxed text-base">
                  Deliver a seamless user experience with intuitive navigation and responsive design.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="text-gray-600 body-font bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">What Makes Our Website Development Services Unique?</h2>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Our website development services are trusted by leading companies worldwide. Here's what sets us apart:
            </p>
          </div>
          <div className="flex flex-wrap -m-4">
            {/* USP 1 */}
            <div className="p-4 md:w-1/2 w-full">
              <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="leading-relaxed text-base">
                  Used by over 10,000 businesses globally, our website development services have a proven track record of driving growth and improving online presence.
                </p>
              </div>
            </div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Hear from businesses that trust our website development services to transform their online presence.
            </p>
          </div>
          <div className="flex flex-wrap -m-4">
            {/* Testimonial 1 */}
            <div className="p-4 md:w-1/2 w-full">
              <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <p className="leading-relaxed mb-6">
                  "The modern design and optimized performance have revolutionized our online presence. The seamless user experience has been a game-changer for our business."
                </p>
            ...
            <div className="p-4 md:w-1/2 w-full">
              <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <p className="leading-relaxed mb-6">
                  "The customer-centric design and seamless user experience have made our website an indispensable tool for our business."
                </p>
                <div className="inline-flex items-center">
                  <img
                    alt="Testimonial"
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
            <h2 className="flex-grow sm:pr-16 text-2xl font-medium text-gray-900">
              Ready to transform your online presence? Join thousands of satisfied clients today!
            </h2>
