  ...
  return (
    <>
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-gray-600">
              Streamline your business processes with integrated ERP systems that connect finance, HR, supply chain, and manufacturing for improved efficiency and decision-making.
            </p>
      ...
      <section className="text-gray-600 body-font bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">What Makes Our ERP Solutions Unique?</h2>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Our ERP solutions are trusted by leading companies worldwide. Here's what sets us apart:
            </p>
          </div>
          <div className="flex flex-wrap -m-4">
            {/* USP 1 */}
            <div className="p-4 md:w-1/2 w-full">
              <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="leading-relaxed text-base">
                  Used by over 10,000 businesses globally, our ERP solutions have a proven track record of driving growth and improving efficiency.
                </p>
              </div>
            </div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Hear from businesses that trust our ERP solutions to transform their operations.
            </p>
          </div>
          <div className="flex flex-wrap -m-4">
            {/* Testimonial 1 */}
            <div className="p-4 md:w-1/2 w-full">
              <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <p className="leading-relaxed mb-6">
                  "The integrated finance and supply chain modules have revolutionized our operations. The real-time data and analytics are invaluable."
                </p>
            ...
            <div className="p-4 md:w-1/2 w-full">
              <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <p className="leading-relaxed mb-6">
                  "The HR management module has streamlined our processes, and the customer-centric design has made it easy for our team to adopt."
                </p>
                <div className="inline-flex items-center">
                  <img
                    alt="Testimonial"
