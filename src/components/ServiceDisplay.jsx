...
import { ArrowRight, ShieldCheck, Flame, Video, Home, Server, Lock, Users, Cog, Globe, Smartphone, ClipboardCheck } from 'lucide-react';
      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/endpoint-security" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/firewall-protection" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/alarms-surveillance" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/home-networking" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/campus-networking" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/vpn-solutions" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/crm" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/erp" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/website" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            ...
            <Link to="/app-design" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col animate-fade-in opacity-0 transition-opacity duration-500">
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
            <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Digital Marketing</h2>
            <p className="leading-relaxed text-base">Boost your online presence with data-driven digital marketing strategies, SEO optimization, social media campaigns, and content marketing to reach your target audience.</p>
            <Link to="/digital-marketing" className="mt-3 text-indigo-500 inline-flex items-center cursor-pointer group">
              Learn More
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />
            </Link>
          </div>
