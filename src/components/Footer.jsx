...
export const Footer = () => {
  ...
  <div class="container px-5 py-10 mx-auto flex md:items-center  md:flex-nowrap flex-wrap flex-col">
  {/* <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col"> */}
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center ">
      ...
      <p class="mt-2 text-sm text-gray-500">Bridging the Digial Divide</p>
    </div>
